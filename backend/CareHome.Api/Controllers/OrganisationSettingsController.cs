    ...
    IOptions<Features.CommercialRevenueFeature> commercialRevenue) : ControllerBase
{
    ...
    public async Task<ActionResult<OrganisationSettingsDto>> Update(UpdateOrganisationSettingsRequest request)
    {
        ...
        tenant.Settings.BillingPeriodMode = BillingPeriodModes.Normalize(request.BillingPeriodMode);
        tenant.Settings.AllowPrivatePayer = request.AllowPrivatePayer;
        tenant.Settings.ShowGuardian = request.ShowGuardian;
        tenant.Settings.FinanceModuleEnabled = request.FinanceModuleEnabled;
    ...
    private static OrganisationSettingsDto ToDto(Models.Tenant tenant, bool financeModuleAvailable)
    {
        return new OrganisationSettingsDto
        {
            ...
            BillingPeriodMode = tenant.Settings.BillingPeriodMode,
            AllowPrivatePayer = tenant.Settings.AllowPrivatePayer,
            ShowGuardian = tenant.Settings.ShowGuardian,
            FinanceModuleEnabled = tenant.Settings.FinanceModuleEnabled,
            FinanceModuleAvailable = financeModuleAvailable
        };
    }
